 ...
 * 
 */
public class UnCheckedStoryDecorator extends TableDecorator {

	
	public String getTitle() {
		long id = ((Story) (this.getCurrentRowObject())).getId();
		String title = ((Story) (this.getCurrentRowObject())).getTitle();
		String link = "<a href=\"pages/Preview.jsf?storyId=" + id + "\"  onclick=\"return openPreviewWindowPopup(this.href)\">"
				+ title + "</a>&nbsp&nbsp";
		return link;
	}
	...
	public String getCheckBox() {
		Story story = (Story) (this.getCurrentRowObject());

		String checkBox = "<input  type=\"checkbox\" name=\"storyIds\" value=\""
				+ story.getId() + "\">";
